...
VIDEO_PATH = "/Users/zehua/GoogleDrive/PythonProject/Face_Recognition/FaceRec_CNN/source/video2.mp4"
HAAR_PATH = "/Users/zehua/GoogleDrive/PythonProject/Face_Recognition/FaceRec_CNN/model/haarcascade_frontalface_alt.xml"
    ...
    def build_camera(self):
        ...
        while success and cv2.waitKey(1) == -1:
            ...
            for (x, y, w, h) in faces:
                ...
                if prob > 0.5:    # 如果模型认为概率高于此阈值, 则显示为模型中已有的label
                    print(prob)
